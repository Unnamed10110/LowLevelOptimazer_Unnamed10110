...
### Option 1: MinGW (gcc)
```bash
gcc -Wall -O2 -o win_optimizer.exe win_optimizer.c -lshell32 -lgdi32
```
...
- **No aggressive RAM clearing**: This optimizer does not purge the standby list or trim background processes, as these can actually make Windows slower by removing useful disk caches and causing page faults.
